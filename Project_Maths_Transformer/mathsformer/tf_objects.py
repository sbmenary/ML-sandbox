...
class FeedForwardBlock(CustomLayer) :
    ...
    def __init__(self, ndim_out:int, ndim_hidden:int, num_hidden_layers:int=1, dropout:float=0, activation='relu', skip_connect:bool=True, layer_norm:bool=False, batch_norm:bool=True, **kwargs) :
        '''
        ...
        Inputs:
            ...
            >  skip_connect, bool, default=True
               Whether to apply skip connection between the input and output; only possible when ndim_out is equal to the input size
